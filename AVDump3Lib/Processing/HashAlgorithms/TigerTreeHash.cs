...
namespace AVDump3Lib.HashAlgorithms {
	...
	public class TTHTiger : TTH.ITigerForTTH {
		...
		public TTHTiger() {
			...
			ZeroArrayHash = (new Tiger()).ComputeHash(new byte[] { 0 });
		...
		protected void ProcessBlock(byte[] inputBuffer, int inputOffset, int iBlkCount) {
			...
			Tiger.BitTools.TypeBlindCopy(inputBuffer, inputOffset, x, 0, iBlkCount * i_InputBlockSize);
		...
		protected byte[] ProcessFinalBlock(byte[] inputBuffer, int inputOffset, int inputCount) {
			...
			Tiger.BitTools.TypeBlindCopy(accu, 0, HashValue, 0, 3);
