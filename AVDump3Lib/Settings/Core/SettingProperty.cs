...
namespace AVDump3Lib.Settings.Core {
	...
	public class SettingProperty : ISettingProperty {
		...
		public SettingProperty(string name, ImmutableArray<string> alternativeNames, ISettingGroup group, Type valueType, object? defaultValue, SettingPropertyValueToObject toObject, SettingPropertyValueToString toString) {
